...
define('C_REST_WEB_HOOK_URL_UFA_BOX', env('BOX'));//BOX
...
class CrestBox
{
	...
	{
		if(defined("C_REST_WEB_HOOK_URL_UFA_BOX") && !empty(C_REST_WEB_HOOK_URL_UFA_BOX))
		{
			$arData = [
				'client_endpoint' => C_REST_WEB_HOOK_URL_UFA_BOX,
				'is_web_hook'     => 'Y'
			];
			$isCurrData = true;
		}
